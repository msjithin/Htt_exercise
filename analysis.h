...
// Tue Mar 19 08:55:20 2019 by ROOT version 6.10/09
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   analysis(const char* file1, const char* file2);
   virtual ~analysis();
...
#ifdef analysis_cxx
analysis::analysis(const char* file1, const char* file2)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
  //if (tree == 0)
  TChain *chain = new TChain("demo/events/Ntuple");
